...
typedef struct _SoupProxyConnection         SoupProxyConnection;
typedef struct _SoupProxyConnectionPrivate  SoupProxyConnectionPrivate;
typedef struct _SoupProxyConnectionClass    SoupProxyConnectionClass;
